...
DATE_TIME=$(str_with_color yellow '%D{%Y-%m-%d %T}')
TIME_PREFIX=$(str_with_color white '[')
TIME_POSTFIX=$(str_with_color white ']')
...
PROMPT='${TIME_PREFIX}${DATE_TIME}${TIME_POSTFIX}${SEPARATOR1}${USER_NAME}${SEPARATOR2}${HOST_NAME}${SEPARATOR3}${CURRENT_DIRECTORY} $(my_git_status)
$PROMPT_CHAR'
